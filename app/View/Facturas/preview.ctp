...
<?php echo $this->Html->image($icono, array('title'=>$titulo,'class'=>'imagentitulo')) ;?><h1><?php echo $titulo;?></h1>
	<div class="actions">
	<?php
	echo $this->Html->link($this->Html->image("back.png",array('title'=>'Volver a la factura')), array('controller'=>'facturas', 'action' => 'view',$factura['Factura']['id']), array( 'escape' => false) );	
...
<div class="<?php echo $divclass;?>"> 
		...
		<table>
			<tr>
				...
				<td style="text-align:right;">					
					<h1>FACTURA</h1>
					<p><b>Fecha: <?php echo $this->Format->date($factura['Factura']['fecha']);?></b></p>		
					<p><b>Factura: <?php echo $factura['Factura']['nfactura'];?></b></p>
	...
	<div id="f_cliente">															
		<table>
			<tr>											
				<td><h3>Cliente</h3><?php echo $factura['Proyecto']['Empresa']['nombre']?></td>
			</tr>
			<tr>							
				<td><?php echo $factura['Proyecto']['Empresa']['cif']?></td>
			</tr>
			<tr>							
				<td><?php echo $factura['Proyecto']['Empresa']['direccion'] ;?></td>
			</tr>
		</table>					
	</div>	
	...
	<div id="f_footer"  style="position: fixed; bottom: -10mm; left: 0;<?php if ($divclass =='preview') echo "display:none";?>">
		<table><tr>
				<td><b>Forma y condiciones de pago:</b> <?php echo FORMA_DE_PAGO;?></td>						
			</tr>
			<tr>
